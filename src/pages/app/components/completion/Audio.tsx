...
export const Audio = ({
  ...
  const { selectedSttProvider, naukriLeloApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(naukriLeloApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          naukriLeloApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
